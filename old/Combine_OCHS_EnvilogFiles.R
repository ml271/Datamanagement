...
#setwd("C:/test")
setwd(paste0("O:/PROJEKT/NIEDER/LOGGER/OCHS/Ochsenhausen_Fichte_ungedüngt_envilog/", vch.Year))
#-----------------------------------------------------------------------------------
...
write.csv2(tbl2, file=paste0("OC_Level2FI_Envilog__", vch.Year,"_combine.csv"), quote = F, row.names = F, na = "")
